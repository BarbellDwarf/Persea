...
/// Build-time rendered documentation pages: `(slug, title, html)` tuples
/// generated by build.rs from `docs/*.md` (see `DOC_FILES` there). The same
/// generated file is included by `src/api/admin.rs` for the admin JSON API;
/// this copy feeds the public docs page template.
