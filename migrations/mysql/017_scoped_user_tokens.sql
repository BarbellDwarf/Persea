-- Scoped user token for the desktop bridge (persea#227) — MySQL variant.
--
...
ALTER TABLE user_api_tokens ADD COLUMN token_type VARCHAR(16) NOT NULL DEFAULT 'user';
ALTER TABLE auth_pending_mfa ADD COLUMN desktop TINYINT(1) NOT NULL DEFAULT 0;
