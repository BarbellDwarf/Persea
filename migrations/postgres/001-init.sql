...
CREATE TABLE IF NOT EXISTS users (
    ...
    totp_secret     BYTEA,                     -- encrypted TOTP secret (NULL if not enrolled)
    disabled        BOOLEAN NOT NULL DEFAULT FALSE,
    expired         BOOLEAN NOT NULL DEFAULT FALSE,
    expiry_date     TEXT,                       -- ISO 8601
    failed_attempts INTEGER NOT NULL DEFAULT 0,
    locked_until    TEXT,                       -- ISO 8601, NULL if not locked
    can_change_password BOOLEAN NOT NULL DEFAULT TRUE,  -- FALSE for LDAP users
...
CREATE TABLE IF NOT EXISTS totp_secrets (
    ...
    secret      BYTEA NOT NULL,                 -- raw TOTP secret bytes
