...
Debian Trixie Docker image for Persea VDI sessions. Provides a MATE desktop, common desktop applications, and PulseAudio redirection over xrdp on port 3389.
...
This image is designed to be launched by persea's VDI driver. Create an address book entry of type **VDI (Docker)** with the image name `trixie-vdi-pulseaudio:latest`.
