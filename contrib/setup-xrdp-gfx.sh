...
For use with persea: https://github.com/sol1/persea
HELPEOF
    exit 0
}
...
# Generated by persea contrib/setup-xrdp-gfx.sh
...
echo ""
echo "Next steps:"
echo "  In persea, enable GFX + H.264 Passthrough on RDP entries"
echo ""
