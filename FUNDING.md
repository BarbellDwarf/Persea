...
- **Test machines** for the desktop client and the RDP/VDI matrix
- **Design work** (the logo system, documentation polish)
- **Development time** for features that do not pay for themselves
